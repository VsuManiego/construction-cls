...
#Project Title: Construction Materials and Equipment Inventory System
#Offering Number: G403
#Group Members: Nicole Casas, Shaddy Rose Labartine, Tess Argelee Seron

import fileinput

def menuDisplay():
    print('===============================')
    print('= Construction Materials and Equipment Inventory System =')
    print('===============================')
